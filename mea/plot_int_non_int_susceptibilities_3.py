...
if __name__=="__main__":
    ...
    # beta 1
    filename_bare_1 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_256_Nk_201.hdf5.pade_wmax_10.0"
    filename_corr_1 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001"
    ...
    # beta 2
    filename_bare_2 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nk_201.hdf5.pade_wmax_10.0"
    filename_corr_2 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001"
    ...
    top_panel_left.set_xlim(left=-0.0,right=4.0)
    top_panel_left.text(-0.15,1.15,"b)",transform=top_panel_left.transAxes,size=20,weight='bold')

    top_panel_left.plot(omega,average_k_t_k_b_jj_1,marker='o',ms=ms,c="red",label=r"$\beta={0:.2f}$".format(beta_corr_1))#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_left.plot(omega,average_k_t_k_b_jj_2,marker='o',ms=ms,c="blue",label=r"$\beta={0:.2f}$".format(beta_corr_2))
    ...
    top_panel_right.set_xlim(left=-0.0,right=4.0)

    top_panel_right.plot(omega,tmp_k_t_k_b_omega_re_sigma_bare_jj_1,marker='>',ms=ms,c="red",label="_nolegend_")#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_right.plot(omega,tmp_k_t_k_b_omega_re_sigma_bare_jj_2,marker='>',ms=ms,c="blue",label="_nolegend_")
    ...
    lower_panel.plot(omega,corr_susceptibility_jj_1,marker='v',ms=ms,c="red",label="_nolegend_")
    lower_panel.plot(omega,corr_susceptibility_jj_2,marker='v',ms=ms,c="blue",label="_nolegend_")
    lower_panel.set_ylabel(r"$\operatorname{Re}\sigma_{jj}(\omega,\mathbf{q}=\mathbf{0})$")
    lower_panel.set_xlabel(r"$\omega$")
    lower_panel.set_xlim(left=-0.0,right=4.0)
    ...
    if "_1D_" in filename_corr_1 and "_1D_" in filename_bare_1:
        plt.savefig("Figure_susceptibility_comparison_inf_jj_U_{0:.2f}_beta_{1:.2f}_{2:.2f}_1D_".format(U_corr_1,beta_corr_1,beta_corr_2)+str_plot_corr.replace(" ","_")+".pdf")
    elif "_2D_" in filename_corr_1 and "_2D_" in filename_bare_1:
        plt.savefig("Figure_susceptibility_comparison_inf_jj_U_{0:.2f}_beta_{1:.2f}_{2:.2f}_2D_".format(U_corr_1,beta_corr_1,beta_corr_2)+str_plot_corr.replace(" ","_")+".pdf")
    ...
    top_panel_left.plot(omega,average_k_t_k_b_szsz_1,marker='o',ms=ms,c="red",label=r"$\beta={0:.2f}$".format(beta_corr_1))#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_left.plot(omega,average_k_t_k_b_szsz_2,marker='o',ms=ms,c="blue",label=r"$\beta={0:.2f}$".format(beta_corr_2))
    handles, labels = plt.gca().get_legend_handles_labels()
    #top_panel_left.legend()
    # 
    ...
    top_panel_right.set_xlabel(r"$\omega$",labelpad=-0.4)
    top_panel_right.set_xlim(left=-0.0,right=4.0)
    top_panel_right.plot(omega,tmp_k_t_k_b_omega_re_sigma_bare_szsz_1,marker='>',ms=ms,c="red",label="_nolegend_")#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_right.plot(omega,tmp_k_t_k_b_omega_re_sigma_bare_szsz_2,marker='>',ms=ms,c="blue",label="_nolegend_")
    #top_panel_right.legend()
    #
    ...
    lower_panel.plot(omega,corr_susceptibility_szsz_1,marker='v',ms=ms,c="red",label="_nolegend_")
    lower_panel.plot(omega,corr_susceptibility_szsz_2,marker='v',ms=ms,c="blue",label="_nolegend_")
    ...
    plt.gcf().set_size_inches(18.5/2.54,12/2.54)
    if "_1D_" in filename_corr_1 and "_1D_" in filename_bare_1:
        plt.savefig("Figure_susceptibility_comparison_inf_szsz_U_{0:.2f}_beta_{1:.2f}_{2:.2f}_1D_".format(U_corr_1,beta_corr_1,beta_corr_2)+str_plot_corr.replace(" ","_")+".pdf")
    elif "_2D_" in filename_corr_1 and "_2D_" in filename_bare_1:
        plt.savefig("Figure_susceptibility_comparison_inf_szsz_U_{0:.2f}_beta_{1:.2f}_{2:.2f}_2D_".format(U_corr_1,beta_corr_1,beta_corr_2)+str_plot_corr.replace(" ","_")+".pdf")
