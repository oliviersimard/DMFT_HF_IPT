...
if __name__=="__main__":
    ...
    filename_corr_inf_1_jj = figure_directory_added+"bb_1D_U_1.000000_beta_25.000000_Ntau_256_Nq_31_Nk_15_infinite_ladder_sum_jj_dos.dat"#"cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001.int_SIMPS"
    ...
    filename_corr_inf_1_szsz = figure_directory_added+"bb_1D_U_1.000000_beta_25.000000_Ntau_256_Nq_31_Nk_15_infinite_ladder_sum_szsz_cut_dos.dat"#"cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001.int_SIMPS"
    ...
    filename_corr_inf_2_jj = figure_directory_added+"bb_1D_U_1.000000_beta_50.000000_Ntau_256_Nq_31_Nk_15_infinite_ladder_sum_jj_dos.dat"#"cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001.int_SIMPS"
    ...
    filename_corr_inf_2_szsz = figure_directory_added+"bb_1D_U_1.000000_beta_50.000000_Ntau_256_Nq_31_Nk_15_infinite_ladder_sum_szsz_cut_dos.dat"#"cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001.int_SIMPS"
    ...
    filename_corr_inf_3_jj = figure_directory_added+"bb_1D_U_1.000000_beta_74.000000_Ntau_256_Nq_31_Nk_15_infinite_ladder_sum_jj_dos.dat"#"cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001.int_SIMPS"
    ...
    filename_corr_inf_3_szsz = figure_directory_added+"bb_1D_U_1.000000_beta_74.000000_Ntau_256_Nq_31_Nk_15_infinite_ladder_sum_szsz_cut_dos.dat"#"cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001.int_SIMPS"
    ...
    bottom_panel_left.text(0.20,0.60,"il correction",transform=bottom_panel_left.transAxes,size=10,weight='bold')
    ...
    #top_panel_left.set_xlabel(r"$\omega$",labelpad=-0.4)
    top_panel_left.set_xlim(left=0.0,right=6.0)
    top_panel_left.set_ylim(bottom=0.0,top=0.3)
    top_panel_left.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    top_panel_left.yaxis.grid(True, which='minor',linestyle='--')
    top_panel_left.xaxis.set_minor_locator(AutoMinorLocator(n=2))
    top_panel_left.xaxis.grid(True, which='minor',linestyle='--')
    top_panel_left.tick_params(axis='x',which="both",bottom=False,labelbottom=False)
    top_panel_left.plot(omega_szsz_1,-1.0*bare_susceptibility_szsz_1,marker='>',ms=2.0,c="coral",label=r"$T={0:.3f}$".format(1.0/beta_corr_1))#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_left.plot(omega_szsz_2,-1.0*bare_susceptibility_szsz_2,marker='>',ms=2.0,c="lightblue",label=r"$T={0:.3f}$".format(1.0/beta_corr_2))
    top_panel_left.plot(omega_szsz_3,-1.0*bare_susceptibility_szsz_3,marker='>',ms=2.0,c="lightgreen",label=r"$T={0:.3f}$".format(1.0/beta_corr_3))
    handles, labels = plt.gca().get_legend_handles_labels()
    top_panel_left.legend(handles,labels,loc="upper right")
    #
    middle_panel_left = fig_szsz.add_subplot(grid[1,0],sharex=top_panel_left)
    middle_panel_left.grid()
    middle_panel_left.set_ylim(bottom=0.0,top=0.3)
    # middle_panel_left.set_title(r"Single-ladder correction to $\langle j_xj_x\rangle$")
    middle_panel_left.text(0.20,0.60,"sl correction",transform=middle_panel_left.transAxes,size=10,weight='bold')
    middle_panel_left.plot(omega_single_corr_szsz_1,-1.0*single_corr_susceptibility_szsz_1,marker='v',ms=2.0,c="coral",label="_nolegend_")
    middle_panel_left.plot(omega_single_corr_szsz_2,-1.0*single_corr_susceptibility_szsz_2,marker='v',ms=2.0,c="lightblue",label="_nolegend_")
    middle_panel_left.plot(omega_single_corr_szsz_3,-1.0*single_corr_susceptibility_szsz_3,marker='v',ms=2.0,c="lightgreen",label="_nolegend_")
    ...
    bottom_panel_left.grid()
    bottom_panel_left.set_ylim(bottom=0.0,top=0.3)
    # bottom_panel_left.set_title(r"Infinite-ladder correction to $\langle j_xj_x\rangle$")
    bottom_panel_left.text(0.20,0.60,"il correction",transform=bottom_panel_left.transAxes,size=10,weight='bold')
    bottom_panel_left.set_xlabel(r"$\omega$",labelpad=-0.4)
    bottom_panel_left.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    ...
    bottom_panel_left.plot(omega_infinite_corr_szsz_1,-1.0*infinite_corr_susceptibility_szsz_1,marker='o',ms=2.0,c="coral",label="_nolegend_")#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    bottom_panel_left.plot(omega_infinite_corr_szsz_2,-1.0*infinite_corr_susceptibility_szsz_2,marker='o',ms=2.0,c="lightblue",label="_nolegend_")
    bottom_panel_left.plot(omega_infinite_corr_szsz_3,-1.0*infinite_corr_susceptibility_szsz_3,marker='o',ms=2.0,c="lightgreen",label="_nolegend_")
    ...
    #top_panel_left.set_xlabel(r"$\omega$",labelpad=-0.4)
    top_panel_middle.set_xlim(left=0.0,right=8.0)
    top_panel_middle.set_ylim(bottom=0.0,top=0.5)
    top_panel_middle.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    top_panel_middle.yaxis.grid(True, which='minor',linestyle='--')
    top_panel_middle.xaxis.set_major_locator(MultipleLocator(2))
    top_panel_middle.xaxis.set_minor_locator(AutoMinorLocator(n=2))
    ...
    top_panel_middle.tick_params(axis='x',which="both",bottom=False,labelbottom=False)
    # top_panel_left.tick_params(axis='y',which="minor",direction="out")
    top_panel_middle.plot(omega_szsz_1_2,-1.0*bare_susceptibility_szsz_1_2,marker='>',ms=2.0,c="red",label=r"$T={0:.3f}$".format(1.0/beta_corr_1_2))#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_middle.plot(omega_szsz_2_2,-1.0*bare_susceptibility_szsz_2_2,marker='>',ms=2.0,c="blue",label=r"$T={0:.3f}$".format(1.0/beta_corr_2_2))
    top_panel_middle.plot(omega_szsz_3_2,-1.0*bare_susceptibility_szsz_3_2,marker='>',ms=2.0,c="green",label=r"$T={0:.3f}$".format(1.0/beta_corr_3_2))
    handles, labels = plt.gca().get_legend_handles_labels()
    top_panel_middle.legend(handles,labels,loc="upper right")
    #
    middle_panel_middle = fig_szsz.add_subplot(grid[1,1],sharex=top_panel_middle)
    middle_panel_middle.grid()
    middle_panel_middle.set_ylim(bottom=0.0,top=0.5)
    # middle_panel_left.set_title(r"Single-ladder correction to $\langle j_xj_x\rangle$")
    middle_panel_middle.text(0.20,0.60,"sl correction",transform=middle_panel_middle.transAxes,size=10,weight='bold')
    middle_panel_middle.plot(omega_single_corr_szsz_1_2,-1.0*single_corr_susceptibility_szsz_1_2,marker='v',ms=2.0,c="red",label="_nolegend_")
    middle_panel_middle.plot(omega_single_corr_szsz_2_2,-1.0*single_corr_susceptibility_szsz_2_2,marker='v',ms=2.0,c="blue",label="_nolegend_")
    middle_panel_middle.plot(omega_single_corr_szsz_3_2,-1.0*single_corr_susceptibility_szsz_3_2,marker='v',ms=2.0,c="green",label="_nolegend_")
    middle_panel_middle.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    middle_panel_middle.yaxis.grid(True, which='minor',linestyle='--')
    middle_panel_middle.xaxis.set_major_locator(MultipleLocator(2))
    middle_panel_middle.xaxis.set_minor_locator(AutoMinorLocator(n=2))
    ...
    bottom_panel_middle.grid()
    bottom_panel_middle.set_ylim(bottom=0.0,top=0.5)
    # bottom_panel_left.set_title(r"Infinite-ladder correction to $\langle j_xj_x\rangle$")
    bottom_panel_middle.text(0.20,0.60,"il correction",transform=bottom_panel_middle.transAxes,size=10,weight='bold')
    bottom_panel_middle.set_xlabel(r"$\omega$",labelpad=-0.4)
    bottom_panel_middle.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    ...
    top_panel_right.text(0.20,0.60,"bare",transform=top_panel_right.transAxes,size=10,weight='bold')
    top_panel_right.set_xlim(left=0.0,right=8.0)
    top_panel_right.set_ylim(bottom=0.0,top=0.4)
    top_panel_right.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    top_panel_right.yaxis.grid(True, which='minor',linestyle='--')
    top_panel_right.xaxis.set_major_locator(MultipleLocator(2))
    top_panel_right.xaxis.set_minor_locator(AutoMinorLocator(n=2))
    top_panel_right.xaxis.grid(True, which='minor',linestyle='--')
    top_panel_right.tick_params(axis='x',which="both",bottom=False,labelbottom=False)
    top_panel_right.plot(omega_szsz_1_3,-1.0*bare_susceptibility_szsz_1_3,marker='>',ms=2.0,c="maroon",label=r"$T={0:.3f}$".format(1.0/beta_corr_1_3))#,label=r"$\mathbf{q}$=%.2f" % (0.0))
    top_panel_right.plot(omega_szsz_2_3,-1.0*bare_susceptibility_szsz_2_3,marker='>',ms=2.0,c="darkblue",label=r"$T={0:.3f}$".format(1.0/beta_corr_2_3))
    top_panel_right.plot(omega_szsz_3_3,-1.0*bare_susceptibility_szsz_3_3,marker='>',ms=2.0,c="darkgreen",label=r"$T={0:.3f}$".format(1.0/beta_corr_3_3))
    handles, labels = plt.gca().get_legend_handles_labels()
    top_panel_right.legend(handles,labels,loc="upper right")
    #
    middle_panel_right = fig_szsz.add_subplot(grid[1,2],sharex=top_panel_right)
    middle_panel_right.grid()
    middle_panel_right.set_ylim(bottom=0.0,top=1.0)
    # middle_panel_left.set_title(r"Single-ladder correction to $\langle j_xj_x\rangle$")
    middle_panel_right.text(0.20,0.60,"sl correction",transform=middle_panel_right.transAxes,size=10,weight='bold')
    middle_panel_right.plot(omega_single_corr_szsz_1_3,-1.0*single_corr_susceptibility_szsz_1_3,marker='v',ms=2.0,c="maroon",label="_nolegend_")
    middle_panel_right.plot(omega_single_corr_szsz_2_3,-1.0*single_corr_susceptibility_szsz_2_3,marker='v',ms=2.0,c="darkblue",label="_nolegend_")
    middle_panel_right.plot(omega_single_corr_szsz_3_3,-1.0*single_corr_susceptibility_szsz_3_3,marker='v',ms=2.0,c="darkgreen",label="_nolegend_")
    middle_panel_right.yaxis.set_minor_locator(AutoMinorLocator(n=2))
    middle_panel_right.yaxis.grid(True, which='minor',linestyle='--')
    middle_panel_right.xaxis.set_major_locator(MultipleLocator(2))
    middle_panel_right.xaxis.set_minor_locator(AutoMinorLocator(n=2))
