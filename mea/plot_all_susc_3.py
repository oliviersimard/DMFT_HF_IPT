...
if __name__=="__main__":
    ...
    # beta 1
    filename_bare_1 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_4096_Nk_301.hdf5.pade_wmax_10.0_m_70_eta_0.001"
    filename_corr_1 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_256_Nq_31_Nk_29_single_ladder_sum.hdf5.pade_wmax_10.0_m_30_eta_0.001"
    filename_corr_inf_1 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_8.200000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001"
    ...
    # beta 2
    filename_bare_2 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_4096_Nk_301.hdf5.pade_wmax_10.0_m_70_eta_0.001"
    filename_corr_2 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_29_single_ladder_sum.hdf5.pade_wmax_10.0_m_30_eta_0.001"
    filename_corr_inf_2 = "cpp_tests/figs_article/bb_1D_U_3.000000_beta_7.600000_Ntau_256_Nq_31_Nk_15_NCA_infinite_ladder_sum.hdf5.pade_wmax_10.0_m_60_eta_0.001"
    ...
    if "_1D_" in filename_corr_inf_1:
        hf_inf_1 = h5py.File(filename_corr_inf_1,"r")
        hf_inf_2 = h5py.File(filename_corr_inf_2,"r")
        list_keys = list(hf_inf_1.keys()); list_keys_other = list(hf_inf_2.keys())
        N_k_t_k_b_1 = len(list_keys); N_k_t_k_b_2 = len(list_keys_other)
        assert N_k_t_k_b_1==N_k_t_k_b_2, "k-grid must be same when considering infinite-ladder corrections: no reasons why otherwise..."
        k_b_t_int_corr_jj_1 = np.empty((N_k_t_k_b_1,),dtype=tuple); k_b_t_int_corr_jj_2 = np.empty((N_k_t_k_b_2,),dtype=tuple)
        k_b_t_int_corr_szsz_1 = np.empty((N_k_t_k_b_1,),dtype=tuple); k_b_t_int_corr_szsz_2 = np.empty((N_k_t_k_b_2,),dtype=tuple)
        for i in range(N_k_t_k_b_1):
            str_k_t_k_b = str(list_keys[i])
            k_b = float(findall(r"(?<=kbar_)([-+]?\d*\.\d+)",str_k_t_k_b)[0])
            k_t = float(findall(r"(?<=ktilde_)([-+]?\d*\.\d+)",str_k_t_k_b)[0])
            # jj
            # data 1
            tmp_k_t_k_b_omega_jj_1 = np.array(hf_inf_1.get(str_k_t_k_b).get('jj'))
            tmp_k_t_k_b_omega_jj_1 = np.array(list(map(lambda x: x.imag,tmp_k_t_k_b_omega_jj_1)))
            k_b_t_int_corr_jj_1[i] = (tmp_k_t_k_b_omega_jj_1,k_b,k_t)
            # data 2
            tmp_k_t_k_b_omega_jj_2 = np.array(hf_inf_2.get(str_k_t_k_b).get('jj'))
            tmp_k_t_k_b_omega_jj_2 = np.array(list(map(lambda x: x.imag,tmp_k_t_k_b_omega_jj_2)))
            k_b_t_int_corr_jj_2[i] = (tmp_k_t_k_b_omega_jj_2,k_b,k_t)
            # szsz
            # data 1
            tmp_k_t_k_b_omega_szsz_1 = np.array(hf_inf_1.get(str_k_t_k_b).get('szsz'))
            tmp_k_t_k_b_omega_szsz_1 = np.array(list(map(lambda x: x.imag,tmp_k_t_k_b_omega_szsz_1)))
            k_b_t_int_corr_szsz_1[i] = (tmp_k_t_k_b_omega_szsz_1,k_b,k_t)
            # data 2
            tmp_k_t_k_b_omega_szsz_2 = np.array(hf_inf_2.get(str_k_t_k_b).get('szsz'))
            tmp_k_t_k_b_omega_szsz_2 = np.array(list(map(lambda x: x.imag,tmp_k_t_k_b_omega_szsz_2)))
            k_b_t_int_corr_szsz_2[i] = (tmp_k_t_k_b_omega_szsz_2,k_b,k_t)

        k_t_k_b_omega_re_sigma_inf_corr_jj_1 = np.zeros((len(omega),),dtype=float); k_t_k_b_omega_re_sigma_inf_corr_jj_2 = np.zeros((len(omega),),dtype=float)
        k_t_k_b_omega_re_sigma_inf_corr_szsz_1 = np.zeros((len(omega),),dtype=float); k_t_k_b_omega_re_sigma_inf_corr_szsz_2 = np.zeros((len(omega),),dtype=float)
        for i in range(N_k_t_k_b_1):
            tmp_k_t_k_b_omega_jj_1 = k_b_t_int_corr_jj_1[i][0]; tmp_k_t_k_b_omega_jj_2 = k_b_t_int_corr_jj_2[i][0]
            tmp_k_t_k_b_omega_szsz_1 = k_b_t_int_corr_szsz_1[i][0]; tmp_k_t_k_b_omega_szsz_2 = k_b_t_int_corr_szsz_2[i][0]
            for j,om in enumerate(omega):
                if om==0.0:
                    # data 1
                    k_t_k_b_omega_re_sigma_inf_corr_jj_1[j] = get_derivative(tmp_k_t_k_b_omega_jj_1[j-2],tmp_k_t_k_b_omega_jj_1[j-1],tmp_k_t_k_b_omega_jj_1[j+1],tmp_k_t_k_b_omega_jj_1[j+2],2.0*wmax/1000)
                    k_t_k_b_omega_re_sigma_inf_corr_szsz_1[j] = get_derivative(tmp_k_t_k_b_omega_szsz_1[j-2],tmp_k_t_k_b_omega_szsz_1[j-1],tmp_k_t_k_b_omega_szsz_1[j+1],tmp_k_t_k_b_omega_szsz_1[j+2],2.0*wmax/1000)
                    # data 2
                    k_t_k_b_omega_re_sigma_inf_corr_jj_2[j] = get_derivative(tmp_k_t_k_b_omega_jj_2[j-2],tmp_k_t_k_b_omega_jj_2[j-1],tmp_k_t_k_b_omega_jj_2[j+1],tmp_k_t_k_b_omega_jj_2[j+2],2.0*wmax/1000)
                    k_t_k_b_omega_re_sigma_inf_corr_szsz_2[j] = get_derivative(tmp_k_t_k_b_omega_szsz_2[j-2],tmp_k_t_k_b_omega_szsz_2[j-1],tmp_k_t_k_b_omega_szsz_2[j+1],tmp_k_t_k_b_omega_szsz_2[j+2],2.0*wmax/1000)
                else:
                    # data 1
                    k_t_k_b_omega_re_sigma_inf_corr_jj_1[j] = tmp_k_t_k_b_omega_jj_1[j]/om
                    k_t_k_b_omega_re_sigma_inf_corr_szsz_1[j] = tmp_k_t_k_b_omega_szsz_1[j]/om
                    # data 2
                    k_t_k_b_omega_re_sigma_inf_corr_jj_2[j] = tmp_k_t_k_b_omega_jj_2[j]/om
                    k_t_k_b_omega_re_sigma_inf_corr_szsz_2[j] = tmp_k_t_k_b_omega_szsz_2[j]/om
            # jj
            # beta 1
            if not np.isnan(k_t_k_b_omega_re_sigma_inf_corr_jj_1).any():
                if isclose(np.abs(k_b_t_int_corr_jj_1[i][1]),np.pi,abs_tol=1e-5) or isclose(np.abs(k_b_t_int_corr_jj_1[i][2]),0.0,abs_tol=1e-5):
                    if isclose(np.abs(k_b_t_int_corr_jj_1[i][1]),np.pi,abs_tol=1e-5) and isclose(np.abs(k_b_t_int_corr_jj_1[i][2]),0.0,abs_tol=1e-5):
                        infinite_corr_susceptibility_jj_1 += 0.25*k_t_k_b_omega_re_sigma_inf_corr_jj_1
                    infinite_corr_susceptibility_jj_1 += 0.5*k_t_k_b_omega_re_sigma_inf_corr_jj_1
                else:
                    infinite_corr_susceptibility_jj_1 += k_t_k_b_omega_re_sigma_inf_corr_jj_1
            # beta 2
            if not np.isnan(k_t_k_b_omega_re_sigma_inf_corr_jj_2).any():
                if isclose(np.abs(k_b_t_int_corr_jj_2[i][1]),np.pi,abs_tol=1e-5) or isclose(np.abs(k_b_t_int_corr_jj_2[i][2]),0.0,abs_tol=1e-5):
                    if isclose(np.abs(k_b_t_int_corr_jj_2[i][1]),np.pi,abs_tol=1e-5) and isclose(np.abs(k_b_t_int_corr_jj_2[i][2]),0.0,abs_tol=1e-5):
                        infinite_corr_susceptibility_jj_2 += 0.25*k_t_k_b_omega_re_sigma_inf_corr_jj_2
                    infinite_corr_susceptibility_jj_2 += 0.5*k_t_k_b_omega_re_sigma_inf_corr_jj_2
                else:
                    infinite_corr_susceptibility_jj_2 += k_t_k_b_omega_re_sigma_inf_corr_jj_2
            # szsz
            # beta 1
            if not np.isnan(k_t_k_b_omega_re_sigma_inf_corr_szsz_1).any():
                if isclose(np.abs(k_b_t_int_corr_szsz_1[i][1]),np.pi,abs_tol=1e-5) or isclose(np.abs(k_b_t_int_corr_szsz_1[i][2]),0.0,abs_tol=1e-5):
                    if isclose(np.abs(k_b_t_int_corr_szsz_1[i][1]),np.pi,abs_tol=1e-5) and isclose(np.abs(k_b_t_int_corr_szsz_1[i][2]),0.0,abs_tol=1e-5):
                        infinite_corr_susceptibility_szsz_1 += 0.25*k_t_k_b_omega_re_sigma_inf_corr_szsz_1
                    infinite_corr_susceptibility_szsz_1 += 0.5*k_t_k_b_omega_re_sigma_inf_corr_szsz_1
                else:
                    infinite_corr_susceptibility_szsz_1 += k_t_k_b_omega_re_sigma_inf_corr_szsz_1
            # beta 2
            if not np.isnan(k_t_k_b_omega_re_sigma_inf_corr_szsz_2).any():
                if isclose(np.abs(k_b_t_int_corr_szsz_2[i][1]),np.pi,abs_tol=1e-5) or isclose(np.abs(k_b_t_int_corr_szsz_2[i][2]),0.0,abs_tol=1e-5):
                    if isclose(np.abs(k_b_t_int_corr_szsz_2[i][1]),np.pi,abs_tol=1e-5) and isclose(np.abs(k_b_t_int_corr_szsz_2[i][2]),0.0,abs_tol=1e-5):
                        infinite_corr_susceptibility_szsz_2 += 0.25*k_t_k_b_omega_re_sigma_inf_corr_szsz_2
                    infinite_corr_susceptibility_szsz_2 += 0.5*k_t_k_b_omega_re_sigma_inf_corr_szsz_2
                else:
                    infinite_corr_susceptibility_szsz_2 += k_t_k_b_omega_re_sigma_inf_corr_szsz_2

        infinite_corr_susceptibility_jj_1 *= 1.0/N_k_t_k_b_1
        infinite_corr_susceptibility_szsz_1 *= 1.0/N_k_t_k_b_1
        infinite_corr_susceptibility_jj_2 *= 1.0/N_k_t_k_b_1
        infinite_corr_susceptibility_szsz_2 *= 1.0/N_k_t_k_b_1
        hf_inf_1.close(); hf_inf_2.close()
    ...
    if "_1D_" in filename_bare_1 and "_1D_" in filename_corr_1:
        fig_jj.suptitle(r"1D IPT ($U={0}$)".format(U_corr_1))
    ...
    top_panel.set_xlim(left=-0.0,right=4.0)
    ...
    if "_1D_" in filename_bare_1 and "_1D_" in filename_corr_1:
        fig_szsz.suptitle(r"1D IPT ($U={0}$)".format(U_corr_1))
    elif "_2D_" in filename_bare_1 and "_2D_" in filename_corr_1:
