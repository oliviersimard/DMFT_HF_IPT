...
class Integrals{
    public:
        ...
        double I2D(std::function<double(double,double)>,double,double,double,double,const double tol=0.000001,unsigned int maxVal=100,bool is_converged=false) const;
        std::complex<double> I2D(std::function<std::complex<double>(double,double,std::complex<double>)>,double,double,double,double,std::complex<double>,const double tol=0.000001,unsigned int maxVal=100,bool is_converged=false) const;
